...
void tampilHistoryRekursif(int index = 0)
{
    if (index == 0)
    {
        system("cls");
    ...
    cout << index + 1 << ". Nama: " << daftarPesanan[index].nama
         << " | Kamar: " << daftarPesanan[index].tipeKamar
         << " | Status: " << daftarPesanan[index].statusLunas << endl;

    tampilHistoryRekursif(index + 1); // Rekursif ke elemen berikutnya
}
